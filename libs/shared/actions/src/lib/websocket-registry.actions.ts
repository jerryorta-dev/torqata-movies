...
import { ConnectionService } from '@tor/shared/models';
...
export const websocketIsDisconnectedAction = createAction(
  '[WebsocketRegistry/API] Service Is Disconnected',
  props<{ id: string }>()
);
...
export const serviceLoggedOutAction = createAction('[Auth] Logged Out');
